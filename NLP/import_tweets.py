...
all([tweet_id == user_id for tweet_id, user_id in 
     zip([x['id'] for x in tweets_users_df['tweet_id']],tweets_users_df['user_id'])])

tweets_users_df.to_csv(r"C:\Users\abhin\OneDrive\Desktop\FSDS CLASS\AUGUST\20 AUGUST(NLP PROJECTS)\19th, 20th  - NLP project\6. NLP PROJECTS\NLP TASKS\TASK - 58\justdoit_tweets_2018_09_07_2.csv", index=False)